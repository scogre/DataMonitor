...
foreach streamyr (2003 2007 2011 2015)
  set analdate_start=${streamyr}120100
  ...
  python ${scriptdir}/call_plot_conv_nsst.py  ${streamyr} ${analdate_start} ${analdate_end}
  python ${scriptdir}/call_plot_rad_nsst.py   ${streamyr} ${analdate_start} ${analdate_end}
end
