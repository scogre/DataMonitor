...
outpath='/lfs3/projects/gfsenkf/Scott.Gregory/CFSR/'
...
do
   ...
   RAD_ANNFILES=$(ls -1d ${outputpath}/RAD*CFSR*$YEARRUN*nc)
   echo RADANNFILES......$RAD_ANNFILES
...
#   fi
   ...
   ###################################################################
   listfilename='latestlist_CFSR'$YEARRUN'.txt'
   dates_in_ann_fname='date_in_CFSRann'$YEARRUN'.txt'
   rm $listfilename
...
################################################################################################################
      RADputcode='/misc/whome/Scott.Gregory/reanalproject/py-ncepbufr-SG/SGmergeNEW/DataMonitor/RAD/put_CFSR.py'
#      CONVputcode='/misc/whome/Scott.Gregory/reanalproject/py-ncepbufr-SG/SGmergeNEW/DataMonitor/CONV/call_putdate_CONV.py'
