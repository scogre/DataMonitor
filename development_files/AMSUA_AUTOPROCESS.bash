...
##rm /httpd-test/external/cgi-bin/forecast-modeling/gefsrr/data_assim/AMSU_cronlog
#bash /httpd-test/external/cgi-bin/forecast-modeling/gefsrr/data_assim/make_date8chanz_VARmodelsIN.bash ${models[*]}
#bash /httpd-test/external/cgi-bin/forecast-modeling/gefsrr/data_assim/make_whole_datelist_amsu_VARmodelsIN.bash ${models[*]}

bash /httpd-test/external/cgi-bin/forecast-modeling/gefsrr/data_assim/make_OVERLAP_datelist_amsu_VARmodelsIN.bash ${models[*]}

makemocode='/httpd-test/external/cgi-bin/forecast-modeling/gefsrr/data_assim/make_AMSU_automonths.bash'
