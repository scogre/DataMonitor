...
from putdate_annual_conv224ONLY import putdate_annual_conv
...
outputpath = '/lustre/f2/dev/Scott.Gregory/monitor/'
...
for var in varnames:
   for region in regions:
      ...
      for year in years:
        outfile = outputpath+'/CONV224ONLY_FV3s'+modelstream+'_'+str(year)+'_'+var+'_'+region+'.nc'
   ...
   for year in years:
     outfile=outputpath+'/CONV224ONLY_FV3s'+modelstream+'_'+str(year)+'_'+var+'_GLOBL.nc'
