...
python /ncrc/home1/Scott.Gregory/reanalproject/py-ncepbufr-SG/SGmergeNEW/DataMonitor/ANNA224/CONV/fillin_stream_reanl224.py ${streamyr} ${analdate_start} ${analdate_end}
#python /lustre/f2/dev/Anna.V.Shlyaeva/DataMonitor/CONV/fillin_stream_reanl224.py ${streamyr} ${analdate_start} ${analdate_end}
