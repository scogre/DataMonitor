...
for yearrun in ${years[*]}; do
   ...
   echo datayr=$datayr
   QSUB='/opt/moab/bin/msub -A nggps_psd -q ldtn -l partition=es -vyearrun='$yearrun',datayr='$datayr' /ncrc/home1/Scott.Gregory/reanalproject/py-ncepbufr-SG/SGmergeNEW/DataMonitor/find_and_put_PICKYEAR_RAD.bash'
   echo $QSUB
   $QSUB
