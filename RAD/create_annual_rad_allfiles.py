...
outputpath='/lfs3/projects/gfsenkf/ashlyaeva/monitor/fv3_reanl/'
  ...
  for year in range(5):
   for nn in range(numinst):
      ...
      for region in regions:
         outfile=outputpath+'/RAD_FVs' + str(streamyear) + '_'+str(streamyear+year)+'_'+instrmnt+'_'+satlite+'_'+region+'.nc'
