...
from putdate_annual_conv224 import putdate_annual_conv
...
for var in varnames:
   for region in regions:
      ...
      for year in years:
        outfile = outputpath+'/CONV224_FV3s'+modelstream+'_'+str(year)+'_'+var+'_'+region+'.nc'
   ...
   for year in years:
     outfile=outputpath+'/CONV224_FV3s'+modelstream+'_'+str(year)+'_'+var+'_GLOBL.nc'
